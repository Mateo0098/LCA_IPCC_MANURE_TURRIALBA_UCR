"""
Escenario A etapa 1. Exporta resultados de emisiones a tabla común.
"""
import numpy as np
...
PARAMS_ETAPA = obtener_parametros_etapa("A", 1)
FACTORES_MMS = obtener_factores_manejo_ipcc("A", 1)
...
# Función: ef_ch4
# ------------------------------------------------------------
FRACCION_MASA_SECA = obtener_fraccion_masa_seca_etapa("A", 1)
