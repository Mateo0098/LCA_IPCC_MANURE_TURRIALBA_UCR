...
def tabla_00_unidad_funcional_y_supuestos() -> Path:
    rows = [
        ...
        {"tipo": "metodo", "nombre": "Caracterización de emisiones y recursos energéticos", "valor": "EF 3.1 e IMN", "unidad": "método de EICV", "descripcion": "Emisiones elementales del manejo y de combustión caracterizadas con EF 3.1; electricidad agregada IMN.", "fuente": "processed/acv_factores_equivalencia.csv; DECISIONES_METODOLOGICAS_TFG.md", "observaciones": "Total climático combinado; sin cadenas de fondo ecoinvent. SimaPro es verificación independiente opcional."},
        {"tipo": "supuesto", "nombre": "Período operativo representativo", "valor": "2026", "unidad": "año de observación", "descripcion": "Patrón observado el 25 de agosto de 2026, anualizado a 365 días; no medición continua anual.", "fuente": "Nota de campo del 25-08-2026", "observaciones": "Consumos conservados; escenarios alternativos."},
        {"tipo": "supuesto", "nombre": "Proxy temporal eléctrico", "valor": "2025", "unidad": "año de factor de consumo", "descripcion": "Último factor de consumo disponible en IMN; no representa actividad ocurrida en 2025.", "fuente": "IMN, portada 16.ª edición 2026; interiores 15a edición / 2025, p. 4", "observaciones": "0,0415 kg CO2-eq/kWh; no usar generación 2024 ni desagregar gases."},
        {"tipo": "supuesto", "nombre": "Proxy sectorial del tractor", "valor": "Residencial y agrícola/Diésel", "unidad": "categoría IMN", "descripcion": "Operación agrícola con toma de fuerza 540E; transporte vial excluido.", "fuente": "IMN, pp. 3–4; decisión metodológica del TFG", "observaciones": "No existe categoría literal tractor; emisiones físicas caracterizadas con EF 3.1."},
    ]
