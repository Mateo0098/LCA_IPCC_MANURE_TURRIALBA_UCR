"""Auditoría reproducible del ledger secuencial de N total y TAN.

La capa es diagnóstica: no sustituye el pipeline climático vigente ni integra
Brightway/ReCiPe. Todos los balances físicos se realizan en kg N/año.
"""
...
PARAMETERS = ROOT / "processed" / "reactive_n_ledger_audit_parameters.csv"
...
def main() -> None:
    ...
    _write(OUTPUT_DIR / "comparacion_ipcc_actual_vs_n_propagado.csv", climate_comparison(management, applications, experimental))
    ...
    print(f"Ledger PASS: 6 etapas; residuo máximo={max(residuals):.3e} kg N")
