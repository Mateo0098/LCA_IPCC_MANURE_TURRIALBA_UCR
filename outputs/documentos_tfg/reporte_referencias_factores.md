...
| B0_T | IPCC | IPCC, ecuación de estimación de CH₄ | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| CH_4_eq | IPCC | IPCC, potencial de calentamiento global | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| EF1 | IPCC | IPCC, ecuación 14 | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| EF3 | IPCC | IPCC | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| EF4 | IPCC | IPCC, ecuaciones 5 y 16 | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| EF5 | IPCC | IPCC, ecuaciones 6 y 18 | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| Fraccion lixiviada MMS | IPCC | IPCC | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| Fraccion volatilizada MMS | IPCC | IPCC | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| MCF | IPCC | IPCC | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| N_2_O_eq | IPCC | IPCC, potencial de calentamiento global | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| Potencial de calentamiento global | IPCC | IPCC, potencial de calentamiento global | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| R_N2_N2O | IPCC | IPCC, ecuación 24 | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| frac_gasm | IPCC | IPCC, ecuación 16 | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
| frac_leach_h | IPCC | IPCC, ecuación 18 | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | Parámetro, ecuación o factor de caracterización asociado con la metodología IPCC. | Resuelto |
...
| NH_3_eq | Revisión manual | Requiere revisión bibliográfica del método EICV | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | El origen no pudo confirmarse sin introducir una referencia no sustentada. | Requiere revisión bibliográfica |
| NO_3_eq | Revisión manual | Requiere revisión bibliográfica del método EICV | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | El origen no pudo confirmarse sin introducir una referencia no sustentada. | Requiere revisión bibliográfica |
| Potencial de eutrofizacion | Revisión manual | Requiere revisión bibliográfica del método EICV | `tabla_05_factores_emision_y_caracterizacion.csv`; apéndices de factores de ambos Word | El origen no pudo confirmarse sin introducir una referencia no sustentada. | Requiere revisión bibliográfica |
